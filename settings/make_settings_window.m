...
Caxis_min=uicontrol('Parent',tools_tab,'Style','Edit','String','','Units','Normalized','Position',[0.05 button_top-3.6*vgap 0.3 0.1],'Tag','Caxis_min_box','Callback',@clim_adjust,'Enable','Off');
...
Caxis_max=uicontrol('Parent',tools_tab,'Style','Edit','String','','Units','Normalized','Position',[0.4 button_top-3.6*vgap 0.3 0.1],'Tag','Caxis_max_box','Callback',@clim_adjust,'Enable','Off');
...
Caxis_auto_button=uicontrol('Parent',tools_tab,'Style','checkbox','Units','Normalized','Position',[0.785 button_top-3.558*vgap 0.07 0.1],'Tag','caxis_auto_button','Enable','Off');
...
AutoSave_button=uicontrol('Parent',saving_tab,'Style','checkbox','Units','Normalized','Position',[0.617 button_top-4.94*vgap 0.063 0.1],'Tag','autosave_button');
